...
{
    public class HGRID_GB_ViewModel:BaseViewModel
    {
        //指令
        ...
        public HGRID_GB_ViewModel(ManualResetEventSlim pauseEvent, SemaphoreSlim semaphore, Action<string> addLog, Action<string> _updateState)
        {
        ...
        public string MainsFrequency
        {
            ...
            set
            {
                _MainsFrequency = Tools.RemoveLeadingZeros(value);
        ...
        #region 市电丢失电压高点
        private string _ACLossVoltHigh;

        public string ACLossVoltHigh
        {
            get { return _ACLossVoltHigh; }
            set
            {
                _ACLossVoltHigh = value;
                this.RaiseProperChanged(nameof(ACLossVoltHigh));
            }
        }
        ...
        private string _ACLossVoltLow;

        public string ACLossVoltLow
        {
            get { return _ACLossVoltLow; }
            set
            {
                _ACLossVoltLow = value;
                this.RaiseProperChanged(nameof(ACLossVoltLow));
            }
        }
        ...
        private string _ACLossFreqHigh;

        public string ACLossFreqHigh
        {
            get { return _ACLossFreqHigh; }
            set
            {
                _ACLossFreqHigh = value;
                this.RaiseProperChanged(nameof(ACLossFreqHigh));
            }
        }
        ...
        private string _ACLossFreqLow;

        public string ACLossFreqLow
        {
            get { return _ACLossFreqLow; }
            set
            {
                _ACLossFreqLow = value;
                this.RaiseProperChanged(nameof(ACLossFreqLow));
            }
        }
        ...
        public void AnalyseStringToElement(string value)
        {
            ...
            try
            {
                ...
                //市电丢失电压高点
                ACLossVoltHigh = Values[2];
                //市电丢失电压低电
                ACLossVoltLow = Values[3];
                //市电丢失频率高点
                ACLossFreqHigh = Values[4];
                //市电丢失频率低电
                ACLossFreqLow = Values[5];
                //市电功率
                ACPower = Values[6];
                ////温度限制
                //TempLimit = Values[3];
