...
{
    public class HGRID_VQ_ViewModel:BaseViewModel
    {
        //指令
        ...
        public HGRID_VQ_ViewModel(ManualResetEventSlim pauseEvent, SemaphoreSlim semaphore, Action<string> addLog, Action<string> _updateState)
        {
